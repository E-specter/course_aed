...
public class CircularListPracticePanel extends JPanel {
    private CircularListController controller;
    private CircularListRenderer renderer;
    private JTextField txtValor, txtIndice;
    private JLabel lblSize;

    public CircularListPracticePanel(CircularListController controller) {
    ...
    private void initComponents() {
        renderer = new CircularListRenderer();
    ...
    public CircularListRenderer getRenderer() { return renderer; }
