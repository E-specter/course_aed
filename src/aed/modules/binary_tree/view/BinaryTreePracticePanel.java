...
public class BinaryTreePracticePanel extends JPanel {
    private BinaryTreeController controller;
    private BinaryTreeRenderer renderer;
    private JTextField txtValor;
    private JLabel lblSize;

    public BinaryTreePracticePanel(BinaryTreeController controller) {
    ...
    private void initComponents() {
        renderer = new BinaryTreeRenderer();
    ...
    public BinaryTreeRenderer getRenderer() { return renderer; }
