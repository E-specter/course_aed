...
public class StackPracticePanel extends JPanel {
    private StackController controller;
    private StackRenderer renderer;
    private JTextField txtValor;
    private JLabel lblSize;

    public StackPracticePanel(StackController controller) {
    ...
    private void initComponents() {
        ...
        controls.add(crearBoton("Push", Theme.SUCCESS, e -> ejecutar("push")), c);

        c.gridx = 0; c.gridy = 1; c.gridwidth = 1;
        controls.add(crearBoton("Pop", Theme.ERROR, e -> ejecutar("pop")), c);
        c.gridx = 1;
    ...
    public StackRenderer getRenderer() { return renderer; }
