...
public class SinglyListPracticePanel extends JPanel {
    private SinglyListController controller;
    private SinglyListRenderer renderer;
    private JTextField txtValor, txtIndice;
    private JLabel lblSize;

    public SinglyListPracticePanel(SinglyListController controller) {
    ...
    private void initComponents() {
        renderer = new SinglyListRenderer();
    ...
    public SinglyListRenderer getRenderer() { return renderer; }
